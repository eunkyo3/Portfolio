        ...
        <div className="grid sm:grid-cols-2 gap-4 lg:gap-6">
          {activities.map((a, idx) => (
            <Reveal key={a.title + a.detail} delay={idx * 0.08}>
              <div className="rounded-2xl border border-neutral-200/80 bg-white/80 p-5 sm:p-6 shadow-sm backdrop-blur-sm hover:-translate-y-1 hover:shadow-xl transition-all hover:border-blue-500/60 dark:border-neutral-800/80 dark:bg-neutral-900/70">
